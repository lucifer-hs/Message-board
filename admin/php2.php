  ...
  <body>
    <div class="container">
      ...
      while($row = mysql_fetch_array($result))
      {
          ...
          echo "<td>" . "<a href='delusers.php?id=$id&username=$username'>删除</a>"."</td>";
          echo "</tr>";
        }
      echo "</table>";
      ?>
      <p>
        <span>用户总数：<?php echo mysql_num_rows(mysql_query("SELECT*from register"));?> ||</span>
        <span><a href="delusers.php?id=0">删除所有用户</a></span>
      </p>
        </div>
      </div>
      <div class="fooster">
